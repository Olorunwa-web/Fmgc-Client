           ...
           <main className = 'container mx-auto px-4 lg:px-12 py-3'>
               <section className = 'flex justify-between items-center'>
                   ...
                   <div className = 'hidden md:flex gap-4'>
                       <Link to = '/auth/signin'><button className = ' font-medium text-[15px] leading-[28px] text-[#D41C1C] border-1 border-solid rounded-[6px] px-[14px] py-[9px]  border-[#D41C1C] hover:bg-[#D41C1C] hover:text-[#FFFFFF]'>Log In</button></Link>
                       <Link to = '/auth/signup'><button className = ' font-medium text-[15px] leading-[28px] text-[#D41C1C] border-1 border-solid rounded-[6px] px-[14px] py-[9px]  border-[#D41C1C] hover:bg-[#D41C1C]  hover:text-[#FFFFFF]'>Sign up</button></Link>
                   </div>
                   <div className = 'md:hidden flex'>
                       <div onClick={() => setIsOpen(true)} >
                         <img src= {harmburg} alt="" className = 'w-[32px]'/>
                       </div>
                       <div className={`fixed top-0 right-0 h-full w-[70%] bg-white z-50 transform transition-transform duration-200
                        ${ isOpen ? "translate-x-0" : "translate-x-full"}`}>
                        <div className = ''>
                         <div className="px-3 py-5 flex flex-col justify-between h-[80vh]">
                            <div className = 'flex justify-end items-cenetr' onClick={() => setIsOpen(false)}>
                            ...
                            <div className = ' ps-4 flex flex-col gap-4 '>
                               <button className = ' font-medium text-[15px] leading-[28px] text-[#D41C1C] border-1 border-solid rounded-[6px] px-[14px] py-[9px]  border-[#D41C1C] hover:bg-[#D41C1C] hover:text-[#FFFFFF]'>Log In</button>
                               <button className = ' font-medium text-[15px] leading-[28px] text-[#D41C1C] border-1 border-solid rounded-[6px] px-[14px] py-[9px]  border-[#D41C1C] hover:bg-[#D41C1C]  hover:text-[#FFFFFF]'>Sign up</button>
                            </div>
                         </div>
                        </div>
                      </div>      
